  ...
  observeEvent(input$submit_password, {
    if (input$password == correct_password) {
      ...
      output$main_ui <- renderUI({
        tagList(
          # Sidebar layout below the wide plot
          sidebarLayout(
            sidebarPanel(
              fluidRow(
          ...
          plotOutput("heatMap", width="100%", height="1500px"),
          plotOutput("conceptNetworkTitle", width="100%", height="100px"),
          plotOutput("conceptNetwork", width="100%", height="1500px"), 
      ...
      observeEvent(input$visualize_gse, {
        ...
        output$heatMap <- renderPlot({
          ...
          #mainheatmap_plot <- cowplot::plot_grid(p2, ncol=1, labels=LETTERS[1:2])
